...
// Caps when tapped, control when held
#define CTRL_CAP LCTL_T(KC_CAPSLOCK)
...
[_BL] = KEYMAP(
  ...
  CTRL_CAP,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_NUHS,KC_ENT,                          \
...
[_WL] = KEYMAP(
  ...
  KC_LCTL,KC_LALT,KC_LGUI,KC_MHEN,        FN_SPC, FN_SPC,                         KC_HENK,KC_RGUI,MO(_FL),KC_RCTL,KC_LEFT,KC_DOWN,KC_RGHT),
